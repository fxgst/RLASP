...
# learnedPolicy = mc.learnPolicy(maxEpisodeLength=20, gamma=1, numberEpisodes=1000, planningFactor=0, planOnEmptyPolicy=True, planningHorizon=12) # {state : action}
# print('Learned policy: %s' % learnedPolicy)
# print()

# testPolicy(learnedPolicy, mc, 20)
